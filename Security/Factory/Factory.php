...
//        $provider = $this->container->get('security.authentication.provider.eficia3_sso_saml');
        ...
        $listenerId = 'duo_atlassian_crowd_authorization.security.authentication.listener.' . $id;
        $listener = new DefinitionDecorator('duo_atlassian_crowd_authorization.security.authentication.listener');
    ...
    function getKey()
    {
        return 'duo_atlassian_crowd_authorization';
    }
